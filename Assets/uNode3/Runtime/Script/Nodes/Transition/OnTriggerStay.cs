namespace MaxyGames.UNode.Transition {
	...
	public class OnTriggerStay : TransitionEvent {
		...
		public override void OnEnter(Flow flow) {
			UEvent.Register<UnityEngine.Collider>(UEventID.OnTriggerStay, flow.target as UnityEngine.Component, (value) => Execute(flow, value));
		}

		public override void OnExit(Flow flow) {
			UEvent.Unregister<UnityEngine.Collider>(UEventID.OnTriggerStay, flow.target as UnityEngine.Component, (value) => Execute(flow, value));
		}
