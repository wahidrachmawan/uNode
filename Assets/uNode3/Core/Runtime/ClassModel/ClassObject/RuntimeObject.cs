...
namespace MaxyGames.UNode {
	...
	public abstract class BaseRuntimeObject : IRuntimeClass {
		...
		public override bool Equals(object other) {
			if(other is BaseRuntimeObject runtimeAsset) {
		...
		public static bool operator ==(BaseRuntimeObject x, BaseRuntimeObject y) {
	...
	public abstract class RuntimeObject : BaseRuntimeObject {
